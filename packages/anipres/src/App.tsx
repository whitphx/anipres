...
function setupDevMock(editor: Editor) {
  ...
  const stepIds = Array.from({ length: 5 }, () => uniqueId());
  const stepOrderKeys = ["a1", "a2", "a3", "a4", "a5"];
  editor.createShape({
    id: rect0Id,
    type: "geo",
    x: 100,
